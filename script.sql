CREATE DATABASE `songs` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE songs;
-- songs.catalogo_fuente definition

CREATE TABLE `catalogo_fuente` (
...
CREATE TABLE `transaccion_songs` (
